...
shell.cp('../binaries/sqlite/4.2.0/napi-v3-linux-armv8/node_sqlite3.node', 'arm64v8.docker/node_sqlite3.node');

// Compile MMS package
shell.exec('docker run --rm -v %CD%/arm64v8.docker:/buildTarget mms/arm64v8 bash /buildTarget/buildMMS-Synology.sh');
...
//shell.cp('binaries/node/node-arm64-rtd1296-synology', 'dist/armv8-synology');
shell.cp('binaries/ffmpeg/linux-armv8/*', 'dist/armv8-synology');
shell.cp('binaries/sqlite/4.2.0/napi-v3-linux-armv8/node_sqlite3.node', 'dist/armv8-synology'); // Use our custom pre-build node-sqlite3 for synology (normal armv8 doesn't work there)
