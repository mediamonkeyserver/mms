...
shell.cp('binaries/ffmpeg/linux-armv7/*', 'dist/armv7-synology');
shell.cp('binaries/sqlite/node-v57-linux-arm-synology/node_sqlite3.node', 'dist/armv7-synology'); // Use our custom pre-build node-sqlite3 for synology (normal armv7 doesn't work there)
