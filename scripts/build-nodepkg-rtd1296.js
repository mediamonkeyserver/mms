...
shell.mkdir('-p', '../binaries/sqlite/4.2.0/napi-v6-linux-armv8/');
shell.mv('crossSynology.docker/bindings/napi-v6-linux-arm/*', '../binaries/sqlite/4.2.0/napi-v6-linux-armv8/');