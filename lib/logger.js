...
var Logger = {
	...
	trace: (msg) => storeDebug('trace', msg),	
	debug: (msg) => storeDebug('debug', msg),
	verbose: (msg) => storeDebug('verbose', msg, true),
	info: (msg) => storeMessage('info', msg),
	warn: (msg) => storeMessage('warning', msg),
	error: (msg) => storeMessage('error', msg),
