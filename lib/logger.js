...
var Logger = {
	...
	trace: function (/*args*/) { storeDebug('trace', Array.from(arguments).join(' ')) },
	debug: function (/*args*/) { storeDebug('debug', Array.from(arguments).join(' ')) },
	verbose: function (/*args*/) { storeDebug('verbose', Array.from(arguments).join(' '), true) },
	info: function (/*args*/) { storeMessage('info', Array.from(arguments).join(' ')) },
	warn: function (/*args*/) { storeMessage('warning', Array.from(arguments).join(' ')) },
	error: function (/*args*/) { storeMessage('error', Array.from(arguments).join(' ')) },
