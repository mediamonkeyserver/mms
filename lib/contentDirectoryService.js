...
class ContentDirectoryService extends Service {
	        ...
	        if (!node.contentURL) {
	            ...
	            request.on('end', () => {
	                if (body == '') {
	                    ...
	                    console.log('Request to update node: ' + node.upnpClass + ', name:' + node.name);
    ...
    createUploadSession(action, request, response, callback) {
        ...
        request.on('end', () => {
            ...
            console.log('createUploadSession: ' + path);
    ...
    processUpload(action, request, response, callback) {
        ...
        console.log('File upload: ' + path + ', range: ' + range);
        ...
        if (val) {
            ...
            //console.log(startBytes + '-' + endBytes + '/' + totalBytes);
        }
