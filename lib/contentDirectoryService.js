...
class ContentDirectoryService extends Service {
	constructor(configuration) {
		...
		this.addType('SortCapabilities', 'string', ['dc:title', 'upnp:genre',
			'upnp:artist', 'upnp:author', 'upnp:album', 'upnp:rating'
		].join(','), [], {
		...
		this.addType('SearchCapabilities', 'string', ['dc:title', 'upnp:genre', 'upnp:artist', 'upnp:author', 'upnp:album', 'upnp:rating'].join(','), [], {
			upnp: Xmlns.UPNP_METADATA,
			dc: Xmlns.PURL_ELEMENT
		});
